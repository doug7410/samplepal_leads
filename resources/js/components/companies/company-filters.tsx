...
function CompanyFiltersComponent({ initialFilters, filterOptions }: CompanyFiltersProps) {
    ...
    const hasActiveFilters = filters.search || (filters.city && filters.city !== 'all') || (filters.state && filters.state !== 'all');

    return (
        <Card className="mb-4 p-4">
            <div className="flex max-w-[700px] flex-col space-y-4">
                ...
                <div className="mt-2 flex items-center gap-3">
                    <Button onClick={applyFilters} disabled={isSubmitting} size="sm">
                        Apply Filters
                    </Button>
                    {hasActiveFilters && (
                        <Button onClick={resetFilters} disabled={isSubmitting} size="sm" variant="outline">
                            Reset All
                        </Button>
                    )}
                </div>
